  ...
  <div class="card-chart card">
    <div class="card-chart card-content">
      <div class="bar-chart-header">
        <div class="bar-chart-title-container">
          <h3 class="bar-card-title">
            Week Working time ({{ contract }} hours contract)
          </h3>
        </div>
        <div class="chart-card-info">Total: {{ totalWeekWorkTime }} hours</div>
        <div class="bar-week-nav">
          <div class="">
            <button class="bar-chart-button" v-on:click="getPreviousWeek">
          ...
          <div class="">
            <span class="chart-card-info">{{ startShow }} - {{ endShow }}</span>
          </div>
          <div class="">
            <button class="bar-chart-button" v-on:click="getNextWeek">
              <svg
