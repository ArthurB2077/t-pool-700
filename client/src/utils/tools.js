...
export default {
  convertLocalToGMT: function (uctLocalDate, withMicro, stoe) {
    ...
    return withMicro
      ? isoDate.toString()
      : isoDate.toString().replace("." + isoDate.toString().split(".")[1], "Z");
  },
  ...
  getWeekWorkTime: function (list) {
    ...
    for (let i = 0; i < weekList.length; i++) {
      ...
      weekWorkTimeByDay[i] = weekWorkTimeByDay[i] / 3.6e6;
    }
    ...
    return {
      weekWorkTimeByDay: weekWorkTimeByDay,
      totalWeekWorkTime: totalWeekWorkTime,
    };
  },
  ...
  getWorkingTimeByMonth: function (list) {
    ...
    for (let i = 0; i < monthList.length; i++) {
      ...
      weekWorkTimeByMonth[i] = weekWorkTimeByMonth[i] / 3.6e6 / 7;
    }
    ...
    return {
      weekWorkTimeByMonth: weekWorkTimeByMonth,
      totalYearTime: totalYearTime,
    };
  },
  getDayStats: function (list) {
    ...
    dayTime = dayTime / 3.6e6;

    workTime = workTime / 3.6e6;
